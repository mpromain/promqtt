...
class PrometheusExporter():
    ...
    def set(self, name, labels, value, fmt='{0}'):
        ...
        logging.debug('Set prom value {name} = {val}'.format(
            name=namestr,
            val=value))
    ...
    def _check_timeout(self):
        ...
        for meas in self._prom.values():
            ...
            for item_name in to_delete:
                del data[item_name]
                msg = "Removed timed out item '{name}'."
                logging.debug(msg.format(name=item_name))
    ...
    def render(self):
        ...
        with self._lock:
            ...
            for k in self._prom:
                ...
                # skip if measurement does not have items
                if not self._prom[k]['data']:
                    continue
